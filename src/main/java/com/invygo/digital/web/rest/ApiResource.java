...
import com.invygo.digital.web.api.ApiApiDelegate;
...
public class ApiResource implements ApiApiDelegate {
    ...
    public ApiResource(RoleAuthorityService roleAuthorityService, RoleAuthorityRepository roleAuthorityRepository) {
     ...
     */
    public Mono<ResponseEntity<RoleAuthority>> createRoleAuthority(RoleAuthority roleAuthority, ServerWebExchange exchange) {
